...
print("\\title{Exercices de multiplication}")
print("\\date{}")
...
for j in range(MULT):
    ...
    print("\\item $"+str(EXO[j][0])+" \\times "+str(EXO[j][1])+"$")
...
#        print("\\begin{minipage}{0.5\linewidth}")
        print("\\begin{enumerate}")
        print("\\setcounter{enumi}{5}")
    print("\\item \shadowbox{\\opmul[displayshiftintermediary=all,displayintermediary=nonzero,hfactor=decimal]{"+str(EXO[j][0])+"}{"+str(EXO[j][1])+"}}")
