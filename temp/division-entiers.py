...
print("\\title{Exercices de division}")
print("\\date{}")
...
#        print("\\begin{minipage}{0.5\linewidth}")
        print("\\begin{enumerate}")
        print("\\setcounter{enumi}{5}")
    print("\\item \shadowbox{\\opdiv[displayshiftintermediary=all,displayintermediary=nonzero,hfactor=decimal]{"+str(EXO[j][0])+"}{"+str(EXO[j][1])+"}}")
